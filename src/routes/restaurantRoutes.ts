...
router.patch("/menu-items/:itemId/availability", verifyMenuItemOwnership, toggleItemAvailability);
...
router.delete("/categories/:categoryId", verifyCategoryOwnership, deleteCategory);
